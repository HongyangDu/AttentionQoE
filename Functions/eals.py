...
from Functions.serializer import deserialize_eals_joblib, serialize_eals_joblib
from Functions.util import Timer
...
@njit(
    # Explicit type annotations slow down computation. Why?
...
# @njit does not improve performance of this function. Better way to implement it?
def _calc_loss_lil(
    cols: np.ndarray,
    data: np.ndarray,
    U: np.ndarray,
